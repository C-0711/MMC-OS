...
7. **`meister-seite-v0.1.md`** — Die Quelle an/aus: eine einzige ruhige Seite, jede Quelle eine Zeile mit Schalter (Zuständigkeit, kein Filter); Antworten kombinieren nur aus AN-Quellen, mit Ehrlichkeitszeile und Quellen-Stand als Teil der Fassung — perfekte Kombinationen aus dem eigenen Leben.
